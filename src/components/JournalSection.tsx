...
export default function JournalSection() {
  const { country, formatPrice } = useAppContext();
  ...
  if (loading) {
    return (
      <div className="py-24 bg-[#050505] text-ivory flex justify-center items-center">
  ...
  return (
    <section id="journal" className="relative py-24 px-6 md:px-16 bg-[#050505] overflow-hidden z-10 border-b border-white/5" dir={isArabic ? 'rtl' : 'ltr'}>
      {/* Editorial Watermark background */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none select-none overflow-hidden opacity-[0.01] w-full text-center">
        <span className="font-serif uppercase text-[15vw] leading-none font-bold tracking-tighter text-white">
          {isArabic ? 'مجلة' : 'JOURNAL'}
        </span>
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          <span className="text-[10px] uppercase tracking-[0.45em] text-gold font-semibold mb-3 block animate-pulse-slow">
        ...
        {selectedCategory === categories[0] && featuredPost && (
          <div className="mb-16">
            <h3 className={`text-[10px] uppercase tracking-[0.3em] text-gold/60 font-sans mb-4 ${isArabic ? 'text-right' : 'text-left'}`}>
