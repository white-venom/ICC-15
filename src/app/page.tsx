    ...
    <main className="relative text-ivory bg-[#050505]">
          ...
          <div className="relative w-full h-full z-[10] select-none">
            ...
            >
                ...
                >
                  ...
                  <div className="flex items-center gap-8 md:ml-auto">
                    ...
                    <button
                      ...
                      className="group relative text-sm uppercase tracking-[0.3em] font-sans text-gold hover:text-ivory transition-colors duration-300 cursor-pointer pb-1"
                      data-cursor="button"
                    >
                      Book Styling
              ...
              >
                <span className="text-xs uppercase tracking-[0.4em] text-ivory/30 font-sans" style={{ writingMode: 'vertical-rl' }}>
                  Scroll
                </span>
                <motion.div
                  animate={{ y: [0, 8, 0] }}
